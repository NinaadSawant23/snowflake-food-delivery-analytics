...
-- Validating the csv files after loading
list @stage_sch.csv_stg;

-- Alternate command to check within sub folder
list @stage_sch.csv_stg/delta/location;

-- SQL Command to check the data in stage location without saving it to a table
select
